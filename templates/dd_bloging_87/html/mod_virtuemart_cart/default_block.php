    ...
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row
                ...
                ">
                <div class=" bd-layoutcolumn-col-1 
 col-md-8">
...
<?php endif; ?></div></div>
		...
		<div class=" bd-layoutcolumn-col-2 
 col-md-12">
...
<?php
    if (preg_match('/[\d\.]+/', trim($product['subtotal_with_tax']), $matches)) {
...
?>
		...
		<div class=" bd-layoutcolumn-col-3 
 col-md-4">
    ...
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row
                ...
                ">
                <div class=" bd-layoutcolumn-col-4 
 col-md-8">
    ...
    <?php echo $cartText; ?>
		...
		<div class=" bd-layoutcolumn-col-5 
 col-md-16">
