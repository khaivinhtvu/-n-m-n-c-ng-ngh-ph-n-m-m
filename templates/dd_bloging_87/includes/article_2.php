...
<div class=" bd-posticonauthor-18">
    <span class=" bd-icon-42"><span><?php echo $data['author-icon']; ?></span></span>
</div>
<?php endif; ?>
	
		<?php if (isset($data['category-icon']) && strlen($data['category-icon'])) : ?>
<div class=" bd-posticoncategory-24">
    <span class=" bd-icon-53"><span><?php echo $data['category-icon']; ?></span></span>
</div>
<?php endif; ?>
    </div>
</div>
...
<a class="bd-postreadmore-2 bd-button-25 " href="<?php echo $data['readmore-link'] ?>" >
    <?php echo $data['readmore-text'] ?></a>
<?php endif; ?>
	
		<p class=" bd-textblock-111 bd-tagstyles bd-content-element">
    <?php
echo <<<'CUSTOM_CODE'
